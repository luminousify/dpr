 <title>DPR | Master PPM Target</title>
...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="<?= base_url('c_new/master_target_ppmAct'); ?>"><button class="btn btn-success">Add Master PPM Target</button></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2">
    ...
    <div class="ibox-content">
            ...
            <div class="table-responsive">
                ...
                <thead>
                 ...
                 <tbody>
                <?php 
                $edit       = base_url('c_new/master_target_ppmAct/ppm_target/id');
                $delete     = base_url('c_new/Delete/master_target_ppm/ppm_target/id/');
                $no = 0;  foreach($data_tabel as $row): $no++;?>
                  <tr>
                      <td class="text-center"><?php echo $no; ?></td>
                      <td><?php echo ($row->tahun) ?></td>
                      <td><?php echo ($row->ppm_target) ?></td>
                      <td>
                        <center>
