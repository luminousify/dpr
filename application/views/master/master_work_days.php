 <title>DPR | Master Work Days</title>
...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <div class="row">
                    	<div class="col">
                            <a href="<?= base_url('c_new/master_work_daysAct'); ?>"><button class="btn btn-success">Add Master Work Days</button></a>
                    	</div>
                    </div>
                </div>
                <div class="col-lg-2">
    ...
    <div class="ibox-content">
            ...
            <div class="table-responsive">
                ...
                <thead>
                 ...
                 <tbody>
                <?php 
                $edit       = base_url('c_new/master_work_daysAct/year_day/id');
                $delete     = base_url('c_new/Delete/master_work_days/year_day/id');
                $no = 0;  foreach($data_tabel as $row): $no++;?>
                  <tr>
                      <td class="text-center"><?php echo $no; ?></td>
                      <td><?php echo ($row->tahun_bulan) ?></td>
                      <td><?php echo ($row->working_day) ?></td>
                      <td><?php echo ($row->daily_wh) ?></td>
                      <td><?php echo ($row->total) ?></td>
                      <td><?php echo ($row->jumlah_mesin) ?></td>
                      <td>
                        <center>
