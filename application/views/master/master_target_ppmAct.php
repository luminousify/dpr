 <title>DPR | Master PPM Target <?= $action; ?></title>
...
<style>
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5><?= $action; ?> Master Data PPM Target</h5>
    ...
    <div class="table-responsive">
     <?php echo form_open('c_new/'.$action.'/ppm_target/master_target_ppm'); ?> 
     <!-- ke function add / nama_table / redirect kemana -->
        ...
        <?php if($action ==  'Edit') {
			...
			echo '<td><input type="text" name="user[0][ppm_target]" id="ppm_target" value="'.$data->ppm_target.'" class="form-control">';
        	echo '</tr>';
            endforeach;
        } ?>
      </table>
...
<?php $this->load->view('layout/footer'); ?>
	...
	var recRow    = '<tr><td><input type="text" name="user['+save+'][tahun]" id="tahun" class="form-control" value="<?php echo date('Y') ?>" readonly></td>' +
		'<td><input type="text" name="user['+save+'][ppm_target]" class="form-control" id="ppm_target" ></td>' +
