 <title>DPR | Master Target Produksi</title>
...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <div class="row">
                    	<div class="col">
                            <a href="<?= base_url('c_new/master_target_produksiAct'); ?>"><button class="btn btn-success">Add Master Target Produksi</button></a>
                    	</div>
                    </div>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Master Data Target Produksi</h5>
            ...
            <div class="table-responsive">
                ...
                <thead>
                  <tr style="text-align: center;">
                    <th>No</th>
                    <th>Tahun</th>
                    <th>Target Prod. Nett</th>
                    <th>Target Prod. Gross</th>
                    <th>Edit</th>
                    <th>Delete</th>
                  </tr>
                 </thead>
                 <tbody>
                <?php 
                $edit       = base_url('c_new/master_target_produksiAct/target_produksi/id/');
                $delete     = base_url('c_new/Delete/master_target_produksi/target_produksi/id/');
                $no = 0;  foreach($data_tabel as $row): $no++;?>
                  <tr>
                      <td class="text-center"><?php echo $no; ?></td>
                      <td><?php echo ($row->tahun) ?></td>
                      <td><?php echo ($row->target_nett) ?></td>
                      <td><?php echo ($row->target_gross) ?></td>
                      <td>
                        <center>
