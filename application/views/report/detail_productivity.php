...
<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <?= form_open('c_dpr/productivity_detail'); ?>  
                                ...
                                <div class="col-sm-3"> <b>Pilih Tahun</b> 
                                    <select name="tahun" value="<?php echo $tahun ?>" class="form-control">
                                        ...
                                        for($i=$tahuns; $i<=$now; $i++){
                                            ?>
                                                <option value="<?php echo $i?>" <?php if($i == $tahun) { echo 'selected="selected"';}?>><?php echo $i; ?></option>;<?php
                   ...
                   <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="align-middle text-center">CT Std</th>
