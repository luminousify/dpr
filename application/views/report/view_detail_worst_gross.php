            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <?php foreach($view_detail_worst->result_array() as $header): ?>
                        <?php endforeach; ?>
                        <h4>Detail Worst Gross <strong><?php echo $header['kode_product'] ?> - <?php echo $header['nama_product'] ?></strong> (<?php echo $bulan ?> - <?php echo $tahun ?>)</h4>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" style="width:100%">
                       <thead>
                        <tr class="text-center">
                            ...
                            <th>CT Std</th>
                            <th>Cavity</th>
                            <th>Production Time (Jam)</th>
                            <th>Qty OK</th>
                            <th>Qty NG</th>
                            <th>Qty LT (Jam)</th>
                            <th>Gross Produksi (Sec)</th>
                            <th>Customer</th>
                            <th>Keterangan</th>
                        </tr>
                        </thead>
                        <tbody>
                            <?php 
                            $no = 0 ; foreach($view_detail_worst->result_array() as $data)
                            {  $no++;
                                echo '<tr>';
