...
<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <?= form_open('c_report/kanit_perform'); ?>  
                    <div class="card rounded mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col"> <b>Line</b>
                                    <select name="line" class="form-control" required="">
                                        <option <?php if( $line ==''){echo "selected"; } ?> value=''>-Pilih Line-</option>
                                        <option <?php if( $line =='A'){echo "selected"; } ?> value='A'>A</option>
                                        <option <?php if( $line =='B'){echo "selected"; } ?> value='B'>B</option>
                                        <option <?php if( $line =='C'){echo "selected"; } ?> value='C'>C</option>
                                    </select>
                                </div>
                            ...
                            <div class="row ml-4">
                                <p><strong>*Catatan :</strong> Silahkan gunakan  <strong>fitur filter</strong> untuk menampilkan data.</p>
                            </div>
                        </div>
                        ...
                        <?= form_close(); ?>
                         <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <table class="table table-bordered dataTables-example" id="datatable2" style="display: none ">
                                                            <thead>
                                                                <tr>
                                                                    <th></th>
                                                    ...
                                                    <hr>
                                                        <table class="table table-bordered dataTables-example" id="datatable3" style="width: 100% ">
                                                            <thead>
                                                                <tr>
                                                                    <th>Kanit</th>
                                                                    <th>Total Produksi</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?= $data['total_lt']; ?></td>
                                                                    <th>
                                                                      <a href="<?= base_url('c_report/detail_ng/' .$dari.'/'.$sampai.'/'. $data['kanit_new']); ?>" class="btn btn-sm btn-danger"><i class="bi-clipboard-data"></i> Detail NG</a>
                                                                      <a href="<?= base_url('c_report/detail_lt/' .$dari.'/'.$sampai.'/'. $data['kanit_new']); ?>" class="btn btn-sm btn-primary"><i class="bi-clipboard-data"></i> Detail LT</a></th>
                                                                </tr>
                                                                <?php } ?>
                                                            </tbody>
                                                        </table>
