                ...
                <div class="ibox-content">
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                                <li><a class="nav-link active" data-toggle="tab" href="#tab-1">Defect By Month</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-2">Defect By Product By Month</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-3">Defect By Kategori By Month</a></li>
                                
                            </ul>
                        <div class="tab-content">
                            <div role="tabpanel" id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    <?php $this->load->view('global/defect/defectYear'); ?>
                                </div>
                            </div>
                            <div role="tabpanel" id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/defect/defectProduct'); ?>
                                </div>
                            </div>
                            <div role="tabpanel" id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/defect/defectKategori'); ?>
                                </div>
                            </div>
