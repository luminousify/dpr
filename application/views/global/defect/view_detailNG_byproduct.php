            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <?php endforeach; ?>
                        <h4>Detail Defect By Product By Machine <strong>(<?php echo $header['kp_pr'] ?> - <?php echo $header['np_pr'] ?>)</strong> <?php echo $bulan ?> - <?php echo $tahun ?></h4>
                ...
                <div class="ibox-content">
                    <?= form_open('c_report/view_detail_ng_byproduct/'.$header['kode_product'].'/'.$bulan); ?>  
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" style="width:100%">
                       <thead>
                        ...
                        <tbody>
                            <?php 
                            $no = 0 ; foreach($view_detail_ng_byproduct->result_array() as $data)
                            {  $no++;
                                echo '<tr>';
