            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <?php foreach($view_header_ng->result_array() as $header): ?>
                        <?php endforeach; ?>
                        <h4>Detail Defect <strong><?php echo $header['kategori'] ?></strong> (<?php echo $bulan ?> - <?php echo $tahun ?>)</h4>
                ...
                <div class="ibox-content">
                    <?= form_open('c_report/view_detail_ng/'.$header['kategori'].'/'.$bulan); ?>  
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" style="width:100%">
                       <thead>
                        ...
                        <tbody>
                            <?php 
                            $view_detail = base_url('c_report/view_detail_ng_bykategori');
                            $no = 0 ; foreach($view_detail_ng->result_array() as $data)
                            {  $no++;
                                echo '<tr>';
                                echo '<td class="text-center">'.$no;'</td>';
                                echo '<td>'.$data['nama'],'</td>';
                                echo '<td>'.$data['kategori'],'</td>';
                                echo '<td class="text-center">'.$data['total_defect'],'</td>';
