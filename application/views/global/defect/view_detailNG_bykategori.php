            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <?php foreach($view_detail_ng_bykategori->result_array() as $header): ?>
                        <?php endforeach; ?>
                        <h4>Detail Defect Detail By Kategori <strong>(<?php echo $header['kp_pr'] ?> - <?php echo $header['np_pr'] ?>)</strong> <?php echo $bulan ?> - <?php echo $tahun ?></h4>
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-bordered table-hover dataTables-example" style="width:100%">
                       <thead>
                        ...
                        <tbody>
                            <?php 
                            $no = 0 ; foreach($view_detail_ng_bykategori->result_array() as $data)
                            {  $no++;
                                echo '<tr>';
                                echo '<td class="text-center">'.$no;'</td>';
                                echo '<td>'.$data['tanggal'],'</td>';
                                echo '<td>'.$data['kp_pr'],'</td>';
                                echo '<td>'.$data['np_pr'],'</td>';
