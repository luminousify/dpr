            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <?php foreach($view_header_lt->result_array() as $header): ?>
                        <?php endforeach; ?>
                        <h4>Detail Loss Time <strong><?php echo $header['kategori'] ?></strong> (<?php echo $bulan ?> - <?php echo $tahun ?>)</h4>
                ...
                <div class="ibox-content">
                    <?= form_open('c_report/view_detail_lt/'.$header['kategori_new'].'/'.$bulan); ?>  
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" style="width:100%">
                       <thead>
                        <tr class="text-center">
                            ...
                            <th class="text-center align-middle">Nama Loss Time</th>
                            <th class="text-center align-middle">Kategori <br>Loss Time</th>
                            <th>Waktu/Time<br> (Hours)</th>
                            <th>Total Mc.Use<br> (Hours)</th>
                            <th>Persentase<br> Loss Time (%)</th>
                            <th>View<br> Detail</th>
                        </tr>
                        </thead>
                        <tbody>
                            <?php 
                            $view_detail = base_url('c_report/view_detail_lt_bykategori');
                            $no = 0 ; foreach($view_detail_lt->result_array() as $data)
                            {  $no++;
                                echo '<tr>';
                                echo '<td class="text-center">'.$no;'</td>';
                                echo '<td>'.$data['nama'],'</td>';
                                echo '<td>'.$data['kategori'],'</td>';
                                echo '<td>'.round($data['total_defect'],1),'</td>';
                                echo '<td>'.$data['total_machine_use'],'</td>';
                                echo '<td>'.$data['persen_lt'],'</td>';
                                echo '<td><center><a href="'.$view_detail.'/'.$data['nama_new'].'/'.$bulan.'"><button class="btn btn-info btn-circle" type="button"><i class="fa fa-search"></i></button></a></td>';
                                echo '</tr>';
                            }  ?>
                        </tbody>
                         <tfoot>
