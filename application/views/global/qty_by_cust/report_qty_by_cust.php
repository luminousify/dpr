...
<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                    <?= form_open('c_report/report_qty_by_cust'); ?>  
                    ...
                    <table class="table table-bordered dataTables-example" id="datatable1" style="width: 100% ">
                                                            <thead>
                                                                <tr>
                                                                    <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">YY</th>
                                                                    <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">YYMM</th>
                                                                    <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">Mo</th>
                                                                    <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">Customer</th>
                                                                    <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">Total</th>
                                                                    <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">OK</th>
                                                                    <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">NG</th>
                                                                    <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">PPM</th>
    
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <?php $id = -1; $no = 0 ; foreach($rep_qty_by_cust->result_array() as $data)
                                                                { $no++; $id++; 
                                                                ?>
                                                                <tr>
                                                                    <td class="text-center align-middle"><?= $data['YY']; ?></td>
                                                                    <td class="text-center align-middle"><?= $data['YY-MM']; ?></td>
                                                                    <td class="text-center align-middle"><?= $data['Mo']; ?></td>
                                                                    <td class="text-center align-middle"><?= $data['customer']; ?></td>
                                                                    <td class="text-center align-middle"><?= $data['total']; ?></td>
                                                                    <td class="text-center align-middle"><?= $data['ok']; ?></td>
                                                                    <td class="text-center align-middle"><?= $data['ng']; ?></td>
                                                                    <td class="text-center align-middle"><?= $data['ppm']; ?></td>
