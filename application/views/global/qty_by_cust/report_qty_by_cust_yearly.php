<title>DPR | Report Qty by Customer</title>
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Report Quantity by Customer</h5>
                ...
                <div class="ibox-content">
                    <?= form_open('c_report/report_qty_by_cust_yearly'); ?>
                    ...
                    <table class="table table-bordered dataTables-example" id="datatable1" style="width: 100%">
                        <thead>
                            <tr>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">Customer</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">Product ID</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">Product Name</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">Total OK</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">01</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">02</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">03</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">04</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">05</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">06</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">07</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">08</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">09</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">10</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">11</th>
                                <th rowspan="1" class="text-center align-middle" style="background:#1ab394;color: white">12</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            foreach ($rep_qty_by_cust->result_array() as $data) {
                            ?>
                                <tr>
                                    <td class="text-left align-middle"><?= $data['Customer']; ?></td>
                                    <td class="text-center align-middle"><?= $data['Product ID']; ?></td>
                                    <td class="text-left align-middle"><?= $data['Product Name']; ?></td>
                                    <td class="text-right align-middle"><?= number_format($data['Total OK']); ?></td>
                                    <td class="text-right align-middle"><?= isset($data['01']) ? number_format($data['01']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['02']) ? number_format($data['02']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['03']) ? number_format($data['03']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['04']) ? number_format($data['04']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['05']) ? number_format($data['05']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['06']) ? number_format($data['06']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['07']) ? number_format($data['07']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['08']) ? number_format($data['08']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['09']) ? number_format($data['09']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['10']) ? number_format($data['10']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['11']) ? number_format($data['11']) : ''; ?></td>
                                    <td class="text-right align-middle"><?= isset($data['12']) ? number_format($data['12']) : ''; ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
        ...
        $(document).ready(function() {
            ...
            $('.dataTables-example').DataTable({
                ...
                buttons: [{
                    ...
                    {
                        extend: 'excel',
                        title: 'Report Quantity by Customer <?php echo $tahun ?>',
                        message: 'Report Quantity by Customer\nYear: <?php echo $tahun ?>'
                    },
                    {
                        extend: 'pdf',
                        title: 'Report Quantity by Customer <?php echo $tahun ?>'
