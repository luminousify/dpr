 <title>DPR | Report Machine Use</title>
...
<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                    <?= form_open('c_machine/machine_use/'); ?>  
                    ...
                    <div class="table-responsive">
                        ...
                        <ul class="nav nav-tabs">
                                <li><a class="nav-link active" data-toggle="tab" href="#tab-1">By Ton By Customer By Month</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-2">By Customer By Month</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-3">Total By Ton By Customer By Year</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-4">Total By Custome By Year</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-5">Total By Customer IEI by Year</a></li>
                            </ul>
                        <div class="tab-content">
                            <div role="tabpanel" id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    <?php $this->load->view('global/machine_use/byton_bycustomer'); ?>
                                </div>
                            </div>
                            <div role="tabpanel" id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/machine_use/bycustomer_bymonth'); ?>
                                </div>
                            </div>

                            <div role="tabpanel" id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/machine_use/total_byton_bycustomer'); ?>
                                </div>
                            </div>
                            
                            <div role="tabpanel" id="tab-4" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/machine_use/total_bymonth_bycustomer'); ?>
                                </div>
                            </div>    

                            <div role="tabpanel" id="tab-5" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/machine_use/bymonthIEI'); ?>
                                </div>
                            </div>                
                        </div>
        ...
        $(document).ready(function() {
         ...
         $(document).ready(function() {         
           ...
           options = {
                 ...
                 title: {
                    text: 'Grafik Total Machine Use By Customer'
                 },
                 xAxis: {
                            //gridLineWidth: 1,
                            labels: {
                 ...
                 colors: ['#f7941d', '#cc113c',  '#663399', '#0f420a', '#9ad88e', '#f36374', '#116a78', '#adcdb4', '#91076b', '#ff6347', '#c9a0dc', '#ccaa88', '#142930', '#114422', '#ddeeee', '#882d17', '#6c8d7d', '#4682b4', '#258a63', '#50bfe6', '#ccaa88'],
                 plotOptions: {
                column: {
                    dataLabels: {
                        enabled: true
         ...
         $(document).ready(function() {         
           ...
           options = {
                 ...
                 title: {
                    text: 'Grafik Total Machine Use By Tonnase'
                 },
                 xAxis: {
                            //gridLineWidth: 1,
                            labels: {
                 ...
                 colors: [ '#4ec4ce', '#f7941d', '#cc113c',  '#663399', '#0f420a', '#9ad88e', '#f36374', '#116a78', '#adcdb4', '#91076b', '#ff6347', '#c9a0dc'],
                 plotOptions: {
                column: {
                    dataLabels: {
                        enabled: true
         ...
         $(document).ready(function() {         
           ...
           options = {
                 ...
                 title: {
                    text: 'Grafik Total Machine Use By Tonnase (Hours)'
                 },
                 xAxis: {
                            //gridLineWidth: 1,
                            labels: {
         ...
         $(document).ready(function() {         
           ...
           options = {
                 ...
                 title: {
                    text: 'Grafik Persentase Machine Use By Tonnase (%)'
                 },
                 xAxis: {
                            //gridLineWidth: 1,
                            labels: {
                 ...
                 colors: ['#f7941d', '#cc113c',  '#663399', '#0f420a', '#9ad88e', '#f36374', '#116a78', '#adcdb4', '#91076b', '#ff6347', '#c9a0dc'],
                 plotOptions: {
                column: {
                    dataLabels: {
                        enabled: true
         ...
         $(document).ready(function() {         
           ...
           options = {
                 ...
                 title: {
                    text: 'Grafik Total Machine Use By Customer (Hours)'
                 },
                 xAxis: {
                            //gridLineWidth: 1,
                            labels: {
                 ...
                 colors: ['#4ec4ce', '#cc113c',  '#663399', '#0f420a', '#9ad88e', '#f36374', '#116a78', '#adcdb4', '#91076b', '#ff6347', '#c9a0dc'],
                 plotOptions: {
                column: {
                    dataLabels: {
                        enabled: true
         ...
         $(document).ready(function() {         
           ...
           options = {
                 ...
                 title: {
                    text: 'Grafik Persentase Machine Use By Customer (%)'
                 },
                 xAxis: {
                            //gridLineWidth: 1,
                            labels: {
