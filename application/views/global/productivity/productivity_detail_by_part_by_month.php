            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Productivity Detail by Part</h5>
                ...
                <div class="ibox-content">
                  <?= form_open('c_report/productivity_detail_by_part_by_month'); ?>  
                   ...
                   <thead>
                    ...
                    <tbody>
                        ...
                        {  $no++;
                            ...
                            echo '<td>'.$data['total_ok'],'</td>';
                            echo '<td>'.$data['total_ng'],'</td>';
                            echo '<td>'.$data['total_nwt'],'</td>';
                            echo '<td>'.$data['total_ot'],'</td>';
                            echo '<td>'.$data['total_cdt'],'</td>';
                            echo '<td>'.$data['total_production_time'],'</td>';
                            echo '<td>'.$data['nett'],'</td>';
                            echo '<td>'.$data['gross'],'</td>';
                            echo '<td>'.$data['persen_nett'],'</td>';
                            echo '<td>'.$data['persen_gross'],'</td>';
