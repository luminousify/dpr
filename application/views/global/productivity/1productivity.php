...
<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                  <?= form_open('c_report/productivity'); ?>  
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                                <li><a class="nav-link active" data-toggle="tab" href="#tab-1">Production Productivity</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-2">10 Worst Net</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-3">10 Worst Gross</a></li>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    <?php $this->load->view('global/productivity/production_productivity'); ?>
                                </div>
                            </div>
                            <div role="tabpanel" id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/productivity/worst_net_productivity'); ?>
                                </div>
                            </div>
                            <div role="tabpanel" id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/productivity/worst_gross_productivity'); ?>
                                </div>
                            </div>
                            <!-- <div role="tabpanel" id="tab-4" class="tab-pane">
                                <div class="panel-body">
                                    <?php //$this->load->view('global/productivity/std_prod'); ?>
                                </div>
                            </div>   -->                        
                        </div>
