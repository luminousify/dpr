...
<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                  <?= form_open('c_report/productivity_by_month'); ?>  
             ...
             <table class="table table-striped table-bordered table-hover dataTables-example5" style="width:100%">
                   <thead>
                    ...
                    <tbody>
                        <?php 
                        $view_detail = base_url('c_report/productivity_by_month');
                        $total = 0; $total_ng = 0;
                        $no = 0 ; foreach($detail_productivity_by_month->result_array() as $data)
                        {  $no++;
                            echo '<tr>';
                            echo '<td>'.$no;'</td>';
                            echo '<td>'.$data['kode_product'],'</td>';
                            echo '<td>'.$data['nama_product'],'</td>';
                            echo '<td>'.$data['tti_gross'],'</td>';
                            echo '<td>'.$data['tti_nett'],'</td>';
                            echo '</tr>';
