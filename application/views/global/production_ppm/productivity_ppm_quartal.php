...
<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                  <?= form_open('c_report/production_qty_quartal'); ?>  
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                                ...
                                <li><a class="nav-link" data-toggle="tab" href="#tab-2">Production Qty & PPM Q2</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-3">Production Qty & PPM Q3</a></li>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    <?php $this->load->view('global/production_ppm/production_ppm_q1'); ?>
                                </div>
                            </div>
                            <div role="tabpanel" id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/production_ppm/production_ppm_q2'); ?>
                                </div>
                            </div>
                            <div role="tabpanel" id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                    <?php $this->load->view('global/production_ppm/production_ppm_q3'); ?>
                                </div>
                            </div>           
                        </div>
                     </div>
...
$(document).ready(function() {         
   ...
   options = {
         ...
         title: {
            text: 'Production Qty & PPM <?= $tahun; ?> (Kuartal 1)'
         },
         xAxis: {
                    //gridLineWidth: 1,
                    labels: {
...
$(document).ready(function() {         
   ...
   options = {
         ...
         title: {
            text: 'Production Qty & PPM <?= $tahun; ?> (Kuartal 2)'
         },
         xAxis: {
                    //gridLineWidth: 1,
                    labels: {
...
$(document).ready(function() {         
   ...
   options = {
         ...
         title: {
            text: 'Production Qty & PPM <?= $tahun; ?> (Kuartal 3)'
         },
         xAxis: {
                    //gridLineWidth: 1,
                    labels: {
