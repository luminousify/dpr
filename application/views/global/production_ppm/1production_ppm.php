...
<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                    <?= form_open('c_report/productionPPM'); ?>  
                    ...
                    <div class="tabs-container">
                      <ul class="nav nav-tabs">
                                <li><a class="nav-link active" data-toggle="tab" href="#tab-1">Total Production Qty Graph</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-2">10 Worst Defect By PPM</a></li>                               
                            </ul>
                            <div class="tab-content">
                              <div role="tabpanel" id="tab-1" class="tab-pane active">
                                  <div class="panel-body">
                                      <?php $this->load->view('global/production_ppm/production_ppm'); ?>
                                  </div>
                              </div>
                              <!-- <div role="tabpanel" id="tab-2" class="tab-pane">
                                  <div class="panel-body">
                                      <?php// $this->load->view('global/production_ppm/worst_defect_ppm'); ?>
                                  </div>
                              </div> -->
