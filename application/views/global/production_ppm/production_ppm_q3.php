<div class="card rounded">
        ...
        <table class="table table-striped table-bordered table-hover dataTables-example" style="width: 100%">
            ...
            <?php endforeach; ?>
            <?php foreach ($total_prod_qty_and_ppm_q3->result_array() as $prod_ppm_detail) : ?>  
            <?php endforeach; ?>
            ...
            <tbody>
                ...
                <?php
                foreach ($f_cost_int_defect_q3->result_array() as $f_cost_int_defect) {
                    echo '<tr>';
                    echo '<td>8</td>';
                ...
                <tr>
                 ...
                 <?php
                foreach ($f_cost_int_defect_q3->result_array() as $fcost_usd) {
                    echo '<tr>';
                    echo '<td>10</td>';
                ...
                <?php
                foreach ($f_cost_int_defect_q3->result_array() as $fcost_idr) {
                    echo '<tr>';
                    echo '<td>11</td>';
