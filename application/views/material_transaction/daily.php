            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5 class="mr-3">Daily Supply Material</h5></a>
                    ...
                    <div class="row">
                            <div class="col-sm-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?= form_open('c_material_transaction/addNew'); ?>  
                                            <div class="row">
                                                <div class="col"><b>Tanggal</b> 
                                                    <input type="date" name="tanggal" class="form-control" required="">
                                                </div>
                                                <div class="col"><b>PIC</b> 
                                                    <select name="pic" class="form-control" id="pic" required="">
                                                      <option value="">-PIlih Salah Satu-</option>
                                                      <?php foreach ($pic as $b) { echo "<option value='$b[nama_actor]'>$b[nama_actor]</option>";}?>
                                                    </select>
                                                </div>
                                                <div class="col-sm">
                                                    <input type="submit" name="add" class="btn btn-md btn-success" value="Add New" style="margin-top:20px;">
                                                </div>
                                            </div>
                                        <?= form_close(); ?>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?= form_open('c_material_transaction/copy'); ?>  
                                        <div class="col-sm">
                                            <div class="row">
                                                        <div class="col-sm-4"><b>Tanggal (mm/dd/yyyy)</b> 
                                                        ...
                                                        <div class="col-sm-2"><input type="submit" name="copy" class="btn btn-md btn-primary" value="Copy" style="margin-top:20px;"></div>
                                                    </div>
                                        </div>
                                        <?= form_close(); ?>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <?= form_open('c_material_transaction/material_transaction_coba'); ?>  
                                <div class="card rounded mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row" style="margin-left:2px;">
                                            ...
                                            <div class="col"><input type="submit" name="show" class="btn btn-warning" style="margin-top:20px;" value="Show"></div>
                                        </div>
                                    </div>
                                    <div class="row ml-4">
                            ...
                            <div class="col-md-4">
                                <div class="card rounded mb-4">
                                    <div class="card-header">
                                        <h2>Supply Material Tambahan</h2>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex justify-content-center">
                                            <div class="row">
                                                <a href="<?php echo base_url('c_material_transaction/addition_supply_material') ?>" class="btn btn-sm btn-info ml-3"><i class="fa fa-plus"></i> Addition Supply Material</a>
                                            </div>
                        ...
                        <div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr >
                                            ...
                                            <th class="text-center align-middle">MC No.</th>
                                            <th class="text-center align-middle">Prod. ID</th>
                                            <th class="text-center align-middle">Prod. Name</th>
                                            <th class="text-center align-middle">Material Name</th>
                                            <th class="text-center align-middle">Stock Mtrl Dlm<br> Mesin</th>
                                            <th class="text-center align-middle">Kebutuhan Mtrl<br>Perhari</th>
                                            <th class="text-center align-middle">Virgin</th>
                                            <th class="text-center align-middle">Regrind</th>
                                            <th class="text-center align-middle">Lot Material</th>
                                            <th class="text-center align-middle">Master Batch</th>
                                            <th class="text-center align-middle">PIC</th>
                                            <th class="text-center align-middle">Keterangan</th>
                                            <th class="text-center align-middle">Edit</th>
                                            <?php
                                            if ($this->session->userdata('posisi') == 'mixer') {
                                                 echo "";
                                            }
                                            else{ ?>
                                    ...
                                    <tbody>
                                        ...
                                        $delete     = base_url('c_material_transaction/Delete/material_transaction_coba/material_transaction/id');
                                            ...
                                            {  $no++;
                                                ...
                                                echo '<td>'.$data->stock_mtrl,'</td>';
                                                echo '<td>'.$data->kebutuhan_mtrl,'</td>';
