...
<style>
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5><?= $action; ?> Material Transaction</h5>
    ...
    <div class="ibox-content">
     ...
     <?php echo form_open('c_material_transaction/'.$action.'/material_transaction/material_transaction_coba'); ?> 
            ...
            <div class="card rounded">
                ...
                <div class="isi mb-1">
                  <table class="table table-bordered stripe row-border order-column" rules="all" id="customFields" style="width: 100%">
                    <thead>
                      <tr>
                        <th style="background:#1ab394;color: white;text-align: center;" class="align-middle">Date</th>
                    ...
                    <tbody>
                      <?php if($action ==  'Edit') {
                        ...
                        class="form-control">';
                        echo '<td><input type="number" name="user[0][stock_mtrl]" value="'.$data->stock_mtrl.'" class="form-control"></td>';
                        echo '<td><select class="form-control" name="user[0][keterangan]"><option value="">Pilih Salah Satu</option><option value="NO MATERIAL">NO MATERIAL</option><option value="NO SCHEDULE">NO SCHEDULE</option><option value="NO SUPPLAY">NO SUPPLAY</option><option value="SUPPLAY">SUPPLAY</option><option value="SUPPLAY CUKUP">SUPPLAY CUKUP</option></select></td>';
                        echo '<td><input type="number" name="user[0][kebutuhan_mtrl]" id="kebutuhan_mtrl" value="'.$data->kebutuhan_mtrl.'" class="form-control" readonly></td>';
                        ...
                        echo '<td><input type="text" name="user[0][pic]" value="'.$data->pic.'" class="form-control" style="width:150px;" readonly>';
                        echo '</tr>';
                        endforeach;
                      } ?>
                    </tbody>
  ...
  $(document).ready(function(){
            $('.autocompleteProductEdit').autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    $('#kebutuhan_mtrl').val(ui.item.keb_mtrl);              
                }
